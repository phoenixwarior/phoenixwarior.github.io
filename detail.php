...
<div class="content remove_pad" onclick="remove_class()">
	...
	<div class="inner_content on_parallax">
		...
		<h2><span class="fresh">Deskripsi Makanan</span></h2>
			...
			<div class="detail_holder">
				...
				<div class="detail_desc">
					...
					<form class="" method="post" action="detail.php">
						...
						<p><span class="bold_desc">Kategori&emsp;&emsp;&nbsp;&nbsp;:</span> <?php echo $cat; ?></p>
						<p><span class="bold_desc">Harga&emsp;&emsp;&emsp;&nbsp;&nbsp;&nbsp;:</span> Rp <?php echo $price; ?></p>
						<div class="form_group">
							
							<p><span class="bold_desc">Jumlah&emsp;&emsp;&emsp;&nbsp;:</span></p>
						...
						<p><span class="bold_desc">Total Harga&emsp;:</span> Rp <?php echo $price; ?></p>

						<div class="form_group">
							<input type="hidden" name="fid" value="<?php echo $id; ?>">
							<input type="submit" name="submit" class="submit add_order" value="Tambah ke Pesanan" />
