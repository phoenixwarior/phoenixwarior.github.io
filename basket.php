...
$result = "";
	...
	$per_page = 20;
		...
		$reserve = $db->query("SELECT * FROM basket WHERE status != 'paidoff' LIMIT $start, $per_page");
		...
		if($reserve->num_rows) {
			...
			$result = "<p style='color:red; padding: 10px; background: #ffeeee;'>Semua meja kosong</p>";
...
<div class="overlay" id="overlay" onclick="hide_overlay()"></div>
	...
	<div class="info_holder">
		...
		<h2><span class="tag">Lengkapi Pesanan Anda</span></h2>
		...
		<form method="post" action="" onSubmit="validate_input(); return false">
			...
			<div class="form_group">
					...
					<div class="container-fluid">
						<div class="row">
							<div class="col-md-12">
								<div class="card">
									<div class="header">
										<h4 class="title">Record Meja yang Terpakai</h4>
									</div>
				...
				<div class="form_group">
					...
					<label>Nomor Meja (1-7)</label>
					<input type="text" id="phone" name="phone" placeholder="Masukan nomor meja dari 1-7 yang belum terpakai" required>
